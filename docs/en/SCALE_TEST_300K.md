...
| **lang** | en |
| **translation** | [Polski](../SCALE_TEST_300K.md) |
| **canonical_path** | docs/en/SCALE_TEST_300K.md |
---
...
## Railway checklist (300k)1. **Postgres volume ≥10 GB** (20 GB recommended). Wipe przed 300k jest **automatyczny** przy re-seedzie; ręczny wipe tylko w razie potrzeby.
...
## Procedura testu 300k1. **Wipe** stare dane symulatora (chunked async wipe).
