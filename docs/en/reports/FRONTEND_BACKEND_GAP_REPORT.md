...
| **lang** | en |
| **translation** | [Polski](../../reports/FRONTEND_BACKEND_GAP_REPORT.md) |
| **canonical_path** | docs/en/reports/FRONTEND_BACKEND_GAP_REPORT.md |
---
...
#### 1. Activity Detail Endpoint```python
...
#### 2. Health Endpoint System```python
...
#### 6. Leaderboard Manager Endpoints```python
# backend/activities/views.py
class LeaderboardViewSet(viewsets.ModelViewSet):
    # CRUD for custom leaderboards
```#### 7. Feature Flags```python
...
### Backend to do:
- **0 endpoints** high priority - all critical ones completed ✅
- **3 endpoints** medium priority (Activity Detail connection, RBAC CRUD, Department Analytics)
- **2 endpoints** low priority (Leaderboard CRUD, Feature Flags CRUD)

**Total: 5 new endpoints to be implemented (end of integration work).**
