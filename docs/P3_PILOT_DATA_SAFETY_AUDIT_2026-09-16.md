...
| DS-010 | Full backup/restore integrity | UNKNOWN | P0 | Home-lab restore proves dump mechanics + `django_migrations`, not full business-data integrity | Seed deterministic multi-tenant business dataset, backup, destroy isolated target, restore, compare critical data/checksums/routes |
| DS-011 | RPO / RTO | UNKNOWN | P0 | Partial Takeover plan explicitly states previous verify-restore is not RPO/RTO evidence; T57 remains planned | Measure and record real RPO/RTO; meet current gate targets or revise by owner decision |
...
- #51 provides an isolated home lab and technical dump/restore mechanism; it is a foundation for, not a substitute for, P3-G business-integrity recovery evidence.
