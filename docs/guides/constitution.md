...
1.  **Strategia "Power Couple" (Python + TypeScript)**: Rdzeń systemu opiera się na unifikacji stosu technologicznego.
    ...
    *   Stos technologiczny: **Next.js 15, RN 0.81, Mantine v7, Skia, PowerSync, Django/FastAPI** stanowi nienaruszalny fundament silnika.
...
3.  **Prywatność i Bezpieczeństwo Ponad Wszystko**: Bezpieczeństwo transakcji finansowych (PCI DSS) oraz absolutna prywatność danych lokalizacyjnych użytkownika są priorytetem najwyższego rzędu. Każda funkcja musi być projektowana przez pryzmat *Privacy-by-Design* (Article 10).

4.  **Identytet Wizualny "Cyber-Monolith"**: Obowiązkowym schematem kolorystycznym platformy jest **Cyan (#00D1FF)** jako kolor podstawowy oraz **Purple (#B066FF)** jako kolor akcentowy. Wszystkie moduły white-label muszą respektować ten fundament wizualny.
