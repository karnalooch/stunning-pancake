...
class Department(models.Model):
    ...
    moderator = models.ForeignKey(
        ...
        on_delete=models.SET_NULL, related_name='moderated_departments'
    )
    department_type = models.CharField(max_length=50, choices=DEPARTMENT_TYPES, default='department')
