...
from .department_serializers import DepartmentSerializer, DepartmentTreeSerializer, UserDepartmentSerializer
...
class DepartmentViewSet(viewsets.ModelViewSet):
    ...
    def tree(self, request):
        ...
        if request.user.role == 'GLOBAL_OWNER':
            ...
            roots = self.get_queryset().filter(parent__isnull=True, tenant_id=request.user.tenant_id)
