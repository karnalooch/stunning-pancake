...
OVERRIDE_MAX_STARTS_HARD_CAP = _int("SCALE_OVERRIDE_MAX_STARTS_HARD_CAP", 1000)
OVERRIDE_MAX_BROUTER_CALLS_HARD_CAP = _int("SCALE_OVERRIDE_MAX_BROUTER_CALLS_HARD_CAP", 500)
