...
class TestPluginRegistry:
    def test_register_and_list(self):
        ...
        manifest = PluginManifest(
            ...
            description='Test plugin', hooks=['activity.verified'],
        )
    ...
    def test_double_register_raises(self):
        ...
        reg = PluginRegistry()
        manifest = PluginManifest(
            name='dup_plugin', version='1.0.0', author='test',
            description='Duplicate test', hooks=[],
        )
        reg.register(manifest)
    ...
    def test_unregister_removes_plugin(self):
        ...
        reg = PluginRegistry()
        manifest = PluginManifest(
            name='removable', version='1.0.0', author='test',
            description='Will be removed', hooks=['x.event'],
        )
        reg.register(manifest)
