...
export const InstanceWizard = ({ opened, onClose }: any) => {
  ...
  return (
    ...
    >
      <Stepper active={active} onStepClick={setActive} color="cyan">
        ...
        <Stepper.Step label="Branding" description="Visual Identity" icon={<Palette size={18} />}>
          <Stack mt="xl">
            <Group grow>
              <ColorInput label="Primary Color" defaultValue="#00D1FF" radius="md" />
              <ColorInput label="Secondary Color" defaultValue="#B066FF" radius="md" />
            </Group>
        ...
        <Stepper.Step label="Compliance" description="RLS & Privacy" icon={<ShieldCheck size={18} />}>
          <Box mt="xl" p="md" bg="rgba(0, 209, 255, 0.05)" style={{ borderRadius: '12px' }}>
