...
# Configuration
TELEMETRY_URL = "https://docker-telemetry-production-cba8.up.railway.app/api/telemetry/traccar/forward"
NUM_ATHLETES = 10
...
async def simulate_athlete(athlete_id):
    ...
    async with httpx.AsyncClient() as client:
        for i in range(100): # 100 points per athlete
            ...
            speed = random.uniform(5.0, 10.0) # 18-36 km/h
            
            payload = {
                "deviceId": device_id,
                "lat": lat,
                "lon": lon,
                "speed": speed / 0.514444, # convert m/s to knots for Traccar protocol simulation
            ...
            try:
                ...
                if resp.status_code != 202:
                    print(f"[{device_id}] Failed: {resp.status_code}", flush=True)
