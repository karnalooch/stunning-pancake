...
3. Używaj Node.js **24.21.0 LTS** i pnpm **12.4.2**. Zainstaluj zależności z **root** monorepo: `pnpm install --frozen-lockfile`; bez globalnego pnpm: `npx pnpm@12.4.2 install --frozen-lockfile`. **Nie** używaj `npm install` w `admin/` — `workspace:*` wymaga pnpm.
